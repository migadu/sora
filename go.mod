...
require (
	...
	github.com/migadu/go-sieve v1.0.1-0.20260623221321-ca9507030c70
...
replace github.com/emersion/go-imap/v2 => github.com/migadu/go-imap/v2 v2.0.0-20260623114121-913f6aa52d2e
