...
func TestProxyUserCommandQuoting(t *testing.T) {
	tests := []struct {
		name         string
		commandLine  string
		wantUsername string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Parse the command line the same way POP3 proxy session does
			parts := strings.Fields(tt.commandLine)
			if len(parts) < 2 {
...
func TestProxyPassCommandQuoting(t *testing.T) {
	tests := []struct {
		name         string
		commandLine  string
		wantPassword string
...
func TestProxyAuthPlainQuoting(t *testing.T) {
	tests := []struct {
		name          string
		commandLine   string
...
func TestProxyAuthPlainContinuationQuoting(t *testing.T) {
	tests := []struct {
		name         string
		response     string
		wantAuthData string
...
func TestProxySASLPlainEncoding(t *testing.T) {
	tests := []struct {
		name     string
		authzID  string
		authnID  string
