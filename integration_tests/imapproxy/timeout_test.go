...
func TestIdleTimeoutTrigger(t *testing.T) {
	...
	initialIdleTimeouts := testutil.ToFloat64(metrics.CommandTimeoutsTotal.WithLabelValues("imap_proxy", "idle"))
	...
	_, writeErr := fmt.Fprintf(conn, "a002 NOOP\r\n")
	...
	newIdleTimeouts := testutil.ToFloat64(metrics.CommandTimeoutsTotal.WithLabelValues("imap_proxy", "idle"))
