...
func TestIdleTimeoutTrigger(t *testing.T) {
	...
	initialIdleTimeouts := testutil.ToFloat64(metrics.ConnectionTimeoutsTotal.WithLabelValues("imap_proxy", "test-proxy", "localhost", "idle"))
	...
	newIdleTimeouts := testutil.ToFloat64(metrics.ConnectionTimeoutsTotal.WithLabelValues("imap_proxy", "test-proxy", "localhost", "idle"))
