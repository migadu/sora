...
// TestIMAPProxyConnectionLimiterCounters tests that connection limiter counters
...
func TestIMAPProxyConnectionLimiterCounters(t *testing.T) {
	...
	// Set up IMAP proxy with specific limits for testing
	proxyAddress := common.GetRandomAddress(t)
	proxyServer := setupIMAPProxyWithConnectionLimits(t, backendServer.ResilientDB, proxyAddress,
	...
	t.Log("=== Testing IMAP Proxy Connection Limiter Counters ===")
...
// TestIMAPProxyConnectionLimiterEnforcement tests that connection limits are properly enforced
func TestIMAPProxyConnectionLimiterEnforcement(t *testing.T) {
	common.SkipIfDatabaseUnavailable(t)
	...
	// Set up IMAP proxy with very restrictive limits
	proxyAddress := common.GetRandomAddress(t)
	proxyServer := setupIMAPProxyWithConnectionLimits(t, backendServer.ResilientDB, proxyAddress,
	...
	t.Log("=== Testing IMAP Proxy Connection Limiter Enforcement ===")
