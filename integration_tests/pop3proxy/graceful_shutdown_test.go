...
// TestPOP3ProxyGracefulShutdownBeforeAuth tests that clients receive -ERR message
// during graceful shutdown when they are in pre-auth state (after greeting, before USER/PASS).
func TestPOP3ProxyGracefulShutdownBeforeAuth(t *testing.T) {
...
// TestPOP3ProxyGracefulShutdownDuringAuth tests that clients receive -ERR message
// during graceful shutdown when they are attempting to authenticate.
func TestPOP3ProxyGracefulShutdownDuringAuth(t *testing.T) {
	common.SkipIfDatabaseUnavailable(t)
...
// TestPOP3ProxyGracefulShutdownAfterAuth tests that clients receive -ERR message
// during graceful shutdown after they have authenticated.
func TestPOP3ProxyGracefulShutdownAfterAuth(t *testing.T) {
	common.SkipIfDatabaseUnavailable(t)
